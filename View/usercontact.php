...
<form  method = "post" action="usercontact.php?action=insert">
...
<div class="divTableRow">
    ...
    <div class="divTableCell"> 
        <input type="varchar" maxlength="30" id="name" placeholder="Enter your name" name="name" required> 
    </div>
    <div class="divTableCell"> 
    <input type="Number" id="phone" placeholder="Enter your number" name="phone" required>
    </div>
    
    <div class="divTableCell"> 
    <input type="varchar" maxlength="250" id="message" placeholder="leave a message" name="message" required>
    </div>
    <div class="divTableCell"> <button type="submit" class="btn btn-default"> Send Message</button> </div>
