...
<style>
		#hero {
		  background: url('images/Logos/TableLogo.jpg') center center no-repeat;
...
<body>
	<div id="header-hero-container">
		<header> 
			...
			<ul id="nav-menu">
                <li><a href="index.php"><img src="images/AboAli/Logo1.jpg" style="width:30px;height:30px;"></a></li>
 ...
 <button class="dropdown-btn">Sports Brands
  ...
  <div class="dropdown-container">
	...
	<li><a href="userReebok.php">Active</a></li>
	<li><a href="userUnderArmor.php">Under Armor</a></li>
	<li><a href="userMizono.php">Mizono</a></li>
	<li><a href="userOther.php">Other</a></li>
                  ...
                  <button class="openbtn" onclick="openNav()">&#9776; Sport Brands</button>
 ...
 <section id='hero'>
    ...
    $result=$myProduct->SelectAllTables();
    $no_of_prod_in_row=5;
        ...
        echo "<div class='column'><div class='card'>";
            ...
            echo "<div class='container'>";
                ...
                echo "<p class='price'>".$result[$j]->price."</p>";
                    echo"<p><a class='card button' href='../View/viewProduct.php?id=".$result[$j]->id."'>View</a></p>";
                    echo"<p><a class='card button' href='=".$result[$j]->id."'>Add to Cart</a></p>";
            echo "</div>";
        echo"</div>";
    echo"</div>";
