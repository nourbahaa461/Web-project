...
$username_err = '<p class="errText">User must be bigger that 5 chars and contain only digits, letters and underscore</p>';
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users (username, password, type) VALUES (?, ?, 1)";
...
<!-- section Register -->
	...
	<section id="contact">
			<div class="container">
        <h2>Please fill out this form to regist a new admin</h2>	
				<div class="flex">
			   ...
			   <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                ...
                <span class="help-block"><?php echo $confirm_password_err; ?></span>
							...
							<button class="rounded"  >Register a new admin</button>
						</form>
					</div>
					</div>
				</div>
